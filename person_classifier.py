...
import time
from utils import load_json_data, create_json_file, create_directory, rename_directory
import numpy as np
import matplotlib.pyplot as plt
import math

DATASET_PATH = 'processed/mfcc/mfcc_80treino_parallel.json'

inputs, targets, mapping = load_json_data(DATASET_PATH, inputs_fieldname='mfcc')
...
if __name__ == '__main__':
    ...
    for random_state in [5438, 53, 14]:
        for _ in range(4):
            ...
            create_json_file(f'datatest/datatest_{random_state}_{inputs.shape[0]}.json', data)
            ...
            create_directory(f'models/{timestamp}')

            create_json_file(f'models/{timestamp}/model_structure.json', model.to_json())
            ...
            rename_directory(f'models/{timestamp}',
